...
export default function ContactSection() {
  ...
  return (
    <section className="relative w-full py-24 md:py-40  overflow-hidden text-black"><InteractiveDotGrid />
          ...
          <AnimatePresence mode="wait">
            {!isSent ? (
              <motion.div 
                ...
                className=" p-8 md:p-16 rounded-[40px] shadow-[0_30px_100px_rgba(0,0,0,0.04)] bg-background"
              >
                <div className="mb-12">
                  <h3 className="font-parkinsans text-3xl mb-2 md:text-5xl font-semibold tracking-tight leading-[0.85]">Be a Part Of Our Team....</h3>
                  <p className="font-montserrat text-black/70">Schedule a consultation to see how we can transform your brand identity into a powerful business asset</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <InputField label="Phone" name="phone" type="tel" placeholder="+1 000" />
                    <InputField label="Email" name="email" type="email" placeholder="jane@co.com" />
                  </div>

                  <div className="flex flex-col gap-2 w-full border-b border-black/10 focus-within:border-primary transition-all pb-3">
                  ...
                  <InputField label="Estimated Budget" name="budget" placeholder="e.g. $10k+" required={false} />
                  <InputField label="Project Details" name="message" placeholder="Describe your goals..." />

                  <div className="flex gap-4 items-start group pt-4">
                    <input type="checkbox" required className=" accent-black h-5 w-5" />
                    <span className="font-outfit text-[14px] text-black/40 leading-relaxed">By checking this, you agree to be contacted regarding your inquiry.</span>
                  </div>

                  <motion.button 
                    disabled={isSubmitting}
                    whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}
                    className="w-full py-6 bg-black text-white font-parkinsans cursor-pointer font-regular tracking-wide text-md rounded-4xl hover:bg-acid-lime hover:text-background transition-all duration-500 disabled:opacity-50"
                  >
              ...
              <motion.div 
                ...
                className="bg-white p-16 md:p-24 rounded-[40px] shadow-2xl border border-primary/20 flex flex-col items-center text-center"
              >
                ...
                <h3 className="font-parkinsans text-4xl font-bold uppercase mb-4">Lead Received</h3>
                <p className="font-outfit text-black/50 text-lg max-w-sm">Our team has secured your request. An architect will reach out to you within 24 hours.</p>
